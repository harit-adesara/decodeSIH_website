...
const seedDatabase = async () => {
  try {
    const mongoUri =
      process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/bharat_swasthya_ai";
    ...
    const hospitalPune = await User.create({
      ...
      hospitalOrClinic:
        "Near Pune Railway Station, Sassoon Road, Pune - 411001",
      createdBy: admin._id,
      isEmailVerified: true,
    });
    ...
    const hospitalMumbai = await User.create({
      ...
      hospitalOrClinic:
        "Acharya Donde Marg, Parel / Andheri Link, Mumbai - 400012",
      createdBy: admin._id,
      isEmailVerified: true,
    });
    ...
    console.log(
      "✅ Created 9 seed user accounts across all 5 roles (Admin, Doctor, Health Assistant, Citizen, Hospital).",
    );
    ...
    const reportsData = [
      {
        title:
          "Cluster of High Febrile Illness with Severe Joint Pain in Ward 14",
        description:
          "Encountered 6 household members with sudden onset 103°F fever, severe behind-eye pain, petechial rashes on forearms, and platelet counts dropping below 85,000/μL. Stagnant rainwater collected in open construction barrels nearby.",
        symptoms: [
          "High Fever",
          "Retro-orbital Pain",
          "Severe Joint Pain",
        ...
        doctorDiagnosis:
          "Confirmed Dengue Viral Hemorrhagic Suspect via NS1 Antigen test.",
        doctorRemarks:
          "Urgent vector control larvicide spray dispatched to Ward 14. Daily platelet monitoring initiated.",
        prescribedAction:
          "Hydration with ORS, Paracetamol 650mg SOS. Strictly avoid Ibuprofen/Aspirin.",
        isPublicAlert: true,
      ...
      },
      {
        ...
        description:
          "Examined 12 children aged 3-10 presenting with harsh barking cough, low-grade fever, rhinorrhea, and audible wheezing. Rapid throat swabs negative for strep.",
        symptoms: [
          "Barking Cough",
          "Sore Throat",
          "Fever 101°F",
        ...
        doctorRemarks:
          "Common in school clusters. Advised 5-day home isolation.",
        prescribedAction:
          "Steam inhalation, saline nasal drops, symptomatic antipyretics.",
        isPublicAlert: true,
        labeledBy: doctor1._id,
      ...
      {
        title:
          "Water Contamination & Acute Watery Diarrhea Outbreak in Slum Pocket",
        description:
          "15 individuals from 4 adjacent tenements reported violent watery loose motions and vomiting within 24 hours. Municipal water pipeline observed leaking near drainage canal.",
        symptoms: [
          "Watery Diarrhea",
          "Vomiting",
          "Severe Dehydration",
        ...
        confirmedDisease:
          "Acute Bacterial Gastroenteritis (E. Coli / Vibrio suspect)",
        isViral: false,
        severity: "critical",
        patientCount: 15,
        image: null,
        ...
        status: "verified_labeled",
        doctorDiagnosis:
          "Water-borne acute diarrheal disease with moderate to severe dehydration.",
        doctorRemarks:
          "Notified BMC water department for immediate super-chlorination of community tanks.",
        prescribedAction:
          "IV Ringer Lactate for 3 severe cases, oral ORS + Zinc supplementation for others.",
        isPublicAlert: true,
        labeledBy: doctor1._id,
      ...
      },
      {
        ...
        description:
          "3 farm workers presented with intermittent high fevers occurring every alternate day, accompanied by intense shivering, rigors, and profuse night sweating.",
        symptoms: [
      ...
      },
      {
        ...
        description:
          "4 senior citizens suffering from excruciating ankle and wrist joint pains, incapacitating movement. Red macular rash spread across trunk.",
        symptoms: [
        ...
        status: "verified_labeled",
        doctorDiagnosis:
          "Serologically confirmed Chikungunya virus IgM positive.",
        doctorRemarks:
          "Supportive physiotherapy and pain management recommended.",
        prescribedAction:
          "Rest, Paracetamol, non-steroidal topical gels, gentle joint mobilizations.",
        isPublicAlert: true,
      ...
      },
      {
        ...
        description:
          "2 college students presenting with 8-day escalating evening fevers, coated tongue, mild hepatosplenomegaly, and abdominal tenderness.",
        symptoms: [
          "Step-ladder Fever",
          "Coated White Tongue",
          "Abdominal Pain",
        ...
        status: "verified_labeled",
        doctorDiagnosis:
          "Widal & Blood Culture positive for Salmonella enterica serotype Typhi.",
        doctorRemarks: "Advised boiled food and strict hand hygiene.",
        prescribedAction:
          "Oral Azithromycin / Cefixime course under physician supervision.",
        isPublicAlert: false,
        labeledBy: doctor1._id,
    ...
    console.log(
      `✅ Seeded ${reportsData.length} comprehensive medical reports.`,
    );
    ...
    const advisoriesData = [
      {
        title:
          "Vector-Borne Disease Surge Alert: Dengue & Chikungunya Protocol",
        message:
          "All Primary Health Centers and ASHA workers across Pune District are directed to intensify door-to-door larval surveys. Ensure distribution of Abate larvicide and inspect overhead water tanks every Friday ('Dry Day'). Direct all febrile cases with platelet count <100k to Sassoon Hospital triage.",
      ...
      {
        title:
          "Monsoon Safe Drinking Water Advisory & Chlorine Tablet Distribution",
        message:
          "Due to localized water pipe damage near suburban railway transit zones, all health workers must conduct spot testing for free residual chlorine (>0.5 ppm). Distribute Halazone chlorine tablets and demonstrate 1-packet-per-liter ORS preparation in community centers.",
      ...
      },
      {
        ...
        message:
          "Elevated H3N2 influenza cases noted in civic schools. Please educate parents on respiratory etiquette, warm saline gargling, and encourage high-risk geriatric patients to receive the annual quadrivalent flu vaccine.",
    ...
    const proactiveAlertsData = [
      {
        ...
        city: "All",
        summary:
          "High vector transmission probability in Pune metropolitan due to sustained 82% relative humidity and intermittent rainfall patterns fostering Aedes mosquito breeding.",
        symptomsToWatch: [
        ...
        aiInsights:
          "Correlated 12 field reports of sudden febrile illness with satellite humidity telemetry (82%), projecting a 42% rise in Aedes vector density over the next 10 days.",
      ...
      },
      {
        ...
        city: "All",
        summary:
          "Clustering of viral upper respiratory tract infections projected across coastal urban belts due to temperature fluctuations and high commuter density.",
        symptomsToWatch: [
        ...
        aiInsights:
          "Aggregated syndromic pediatric cough records and meteorological barometric pressure shifts indicating seasonal airborne transmission window.",
      ...
      },
      {
        ...
        city: "Andheri",
        summary:
          "Critical water contamination warning for low-lying sectors following drainage overflows. Risk of acute diarrheal disease and food poisoning.",
        symptomsToWatch: [
        ...
        aiInsights:
          "Correlated water pipeline turbidity alerts with 15 acute diarrheal admissions across K-East municipal ward.",
      ...
      },
      {
        ...
        city: "All",
        summary:
          "Active surveillance for daytime Aedes mosquito bites causing sudden polyarthritis and febrile episodes across western districts.",
        symptomsToWatch: [
        ...
        aiInsights:
          "AI model matched 4 confirmed Chikungunya IgM positive reports from Ahmedabad civil hospital with warm daytime thermal indices.",
    ...
    console.log(
      `✅ Seeded ${proactiveAlertsData.length} proactive AI disease outbreak forecasts.`,
    );

    // 5. Seed Hospital Wards & Bed Availability
    console.log(
      "🏥 Seeding hospital wards and live bed capacity across India...",
    );
    ...
    const hospitalWardsData = [
      // Sassoon General Hospital (Pune, Maharashtra)
      {
        ...
        notes:
          "Equipped with automated dialysis ports and dedicated crash carts.",
        isActive: true,
      },
      {
        hospital: hospitalPune._id,
      ...
      },
      {
        ...
        notes:
          "Ideal for recovering post-fever and medical stabilization patients.",
        isActive: true,
      },
      {
        hospital: hospitalPune._id,
        ...
        amenities: [
          ...
          "HEPA Filtration",
          "Dedicated PPE Antechamber",
        ],
        notes:
          "Strict contagion barrier protocol for active Dengue, H1N1, and Cholera cases.",
        isActive: true,
      },
      {
        hospital: hospitalPune._id,
      ...
      },
      {
        ...
        notes:
          "Specialized respiratory recovery unit for seasonal viral pneumonia convalescents.",
        isActive: true,
      },
      ...
      // KEM Hospital (Mumbai, Maharashtra)
      {
        ...
        pricePerDay: 6000,
        amenities: [
          "24/7 Cath Lab Backup",
          "Intra-Aortic Balloon Pump",
          "Continuous Invasive Hemodynamics",
        ],
      ...
      },
      {
        ...
        amenities: [
          ...
          "Skin Grafting Station",
          "Hydrotherapy Unit",
        ],
        notes:
          "Specialized antiseptic burn care unit with isolated dressing suites.",
        isActive: true,
      },
      {
        hospital: hospitalMumbai._id,
        ...
        amenities: [
          ...
          "Central Oxygen Lines",
          "Regular Resident Doctor Rounds",
        ],
        notes:
          "Public municipal healthcare ward with full fee concessions for BPL cardholders.",
        isActive: true,
      },
    ...
    console.log(
      `✅ Seeded ${hospitalWardsData.length} hospital wards with diverse types, capacity & pricing.`,
    );
