  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 bg-slate-900/60 backdrop-blur-md animate-fadeIn">
      <div className="w-full max-w-3xl h-full sm:h-auto sm:max-h-[92vh] flex flex-col rounded-none sm:rounded-3xl bg-white border-0 sm:border border-slate-200 shadow-2xl overflow-hidden transition-all">
        {/* Modal Header */}
        <div className="p-4 sm:p-6 bg-gradient-to-r from-teal-800 via-teal-900 to-slate-900 text-white relative flex-shrink-0">
          <button
            onClick={onClose}
          ...
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-2 pr-8 sm:pr-0">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-rose-500/20 text-rose-200 border border-rose-400/30 text-[10px] sm:text-xs font-bold uppercase tracking-wider">
              <Bug className="w-3.5 h-3.5 text-rose-400" />
              Contagious Viral Pathogen
            </span>

            <span className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] sm:text-xs font-bold border ${severityBadge.bg}`}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-2.5 mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-white/15">
            <div className="p-2 sm:p-2.5 rounded-xl bg-white/10 backdrop-blur-sm border border-white/10">
              <div className="text-[9px] sm:text-[10px] uppercase font-semibold text-teal-200/80">Total Cases</div>
